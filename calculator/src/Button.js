    ...
    render() {
        return (
            <div className="container">
                <input className="btn" type="button" value={this.props.btn_value} style={{backgroundColor:this.props.backgroundColor, color:this.props.fontColor, width:this.props.width, textAlign:this.props.txt_align, paddingLeft:this.props.padding_left}}  />
            </div>
        );
    }
}
